...
var (
	loc = localization{
		m: map[string]string{
			...
			"k_card":          "Игрок, вытянувший карту, придумывает движение, которое нужно исполнить перед тем, как пить дальше. С каждым новым королём добавляется ещё одно движение — вплоть до четырёх в строго установленном порядке. Тот, кто забыл выпить — пьёт ещё раз.",
