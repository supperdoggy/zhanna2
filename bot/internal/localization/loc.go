	...
	loc = localization{
		m: map[string]map[string]string{
			"ru": {
				...
				"need_reply_create_admin": "Ответь на сообщение кого надо сделать админом",
				...
				"add_flower_args":          "Попробуй /addflower <count> ",
				"count_error":              "Count должен быть 2 или больше",
				"need_reply_add_flower":    "Тебе надо ответить на сообщение того кому ты хочешь сделать цветочек/цветочки",
				"add_user_flower_multiple": "Ты успешно дал для %v %v цветочков",
				"add_user_flower":          "Ты успешно создал %v для %v",
			},
			"uk": {
				"zhanna_has_flower":       "Жанночки",
				...
				"give_flower_instruction": "Тобі потрібно відповісти на повідомлення людини, якій ти хочеш подарувати квітку, а потім написати @Zhanno4kabot і обрати квіточку в меню :)",
				...
				"need_reply_create_admin": "Відповідай на повідомлення того, кого потрібно зробити адміном",
				...
				"add_flower_args":          "Спробуй /addflower <count> ",
				"need_reply_add_flower":    "Потрібно відповісти на повідомлення того кому ти хочеш зробити квіточку/квіточки",
				"count_error":              "Count повинен бути 2 або більше",
				"add_user_flower_multiple": "Ти успішно дав для %v %v квіточків",
				"add_user_flower":          "Ти успішно створив %v для %v",
			},
		},
		danet: map[string][]string{
